...
const DecoBG: React.FC<DecoBGProps> = () => {
    return (
      <div className="fixed inset-0 -z-10 overflow-hidden w-full bg-[#0a0a0a] h-full">
      ...
      <div
        ...
        width: "400px",
        height: "400px",
        background: "radial-gradient(circle at 30% 30%, #60cc87 0%, transparent 40%)",
        opacity: 0.35,
        filter: "blur(40px)",
        zIndex: 0,
        }}
      ...
      <div
        ...
        width: "400px",
        height: "400px",
        background: "radial-gradient(circle at 70% 70%, #60cc87 0%, transparent 40%)",
        opacity: 0.25,
        filter: "blur(40px)",
        zIndex: 0,
        }}
